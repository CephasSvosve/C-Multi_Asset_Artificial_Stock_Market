...
namespace esl::economics::finance {
    ...
    public:
        ...
        ///
        std::map<std::tuple<identity<company>, share_class>, identity<law::property>> stocks;
        std::map<identity<esl::law::property>, double> data_shares_outstanding;
        std::map<identity<esl::law::property>, std::vector<double>> data_earnings;
        std::map<identity<esl::law::property>, std::vector<double>> data_dividends;
        std::map<identity<esl::law::property>, std::vector<double>> data_free_cash_flow;
